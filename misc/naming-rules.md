...
### 传播名注意事项
产品传播名中，品牌名无论叫「一加」还是叫「OnePlus」都没有问题，但在重新并入 OPPO 之前，官方宣发品牌名为「OnePlus」
...
- `一位字母`: 区分渠道版本，`A` `E` - 全网通版，`C` - 全网通版或运营商定制版（2019 及之前），`G` `H` `Y` - 国际版，`I` `P` - 印度版，`L` - 拉丁美洲版，`R` - 日版，`T` - 运营商定制版或泰国版
