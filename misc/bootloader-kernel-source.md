...
| 品牌 | Bootloader 解锁 | 解锁等待时长（小时） | Linux 内核开源 | 解锁后保修状态 | 备注 |
| :-: | :-: | :-: | :-: | :-: | :-: |
| 360 手机 | ✅ | -- | ❌ | -- | -- |
| 黑鲨 (Black Shark) | ❌ | -- | ❌ | -- | -- |
| 酷派 (Coolpad) | ✅ | -- | ❌ | -- | -- |
